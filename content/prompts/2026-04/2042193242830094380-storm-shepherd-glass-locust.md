...
full_text: |-
  ...
  wrote a highly-specific micro-script and fed it into seedance 2.0.
  the result is pure cinematic crack.

  getting ai video to look good isn't the subject, it's prompting for textures (chitin, glass, salt) and specific camera movement (orbit, tracking shots).
